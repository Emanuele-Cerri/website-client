import { PricingTypology } from '@/interfaces/pricing'
import { Box, Button, Text } from '@chakra-ui/react'
import React, { FC } from 'react'

const PricingCard: FC<{ element: PricingTypology }> = ({ element }) => {
    return (
        <Box>
            <Box
                bg={'hover'}
            ...
            >
                ...
                <Box
                    ...
                    gap={'16px'}
                >
                    {element.price.length <= 4 && <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
